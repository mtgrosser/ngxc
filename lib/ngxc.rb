module Ngxc
  ...
  class Configuration < Configurable
    ...
    def ngxc_info
      rem 'This file will be automatically generated by ngxc from the'
      rem "#{@config_file} file. All changes to this file will be lost."
      rem "\nauto-generated by ngxc @ #{Time.now}"
      self << ""
    end
